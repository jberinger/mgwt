...
import com.googlecode.mgwt.dom.client.event.pointer.MsPointerEvent;
...
public class DOMImplIE10 extends DOMImplIE9 {
  ...
  static
  {
    MsPointerEvent.MSPOINTERDOWN = MSPOINTERDOWN;
    MsPointerEvent.MSPOINTERMOVE = MSPOINTERMOVE;
    MsPointerEvent.MSPOINTEROUT = MSPOINTEROUT;
    MsPointerEvent.MSPOINTEROVER = MSPOINTEROVER;
    MsPointerEvent.MSPOINTERUP = MSPOINTERUP;
    MsPointerEvent.MSPOINTERCANCEL = MSPOINTERCANCEL;
